...
import br.com.aceleradev.biblioteca.utils.SecurityConstant;
...
import static br.com.aceleradev.biblioteca.utils.SecurityConstant.*;
import static br.com.aceleradev.biblioteca.utils.SecurityConstant.EXPIRATION_TIME;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
            ...
            throw new ResourceNotFoundException("Usuario nao existe");
        }
    }
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        response.addHeader(HEADER_STRING, bearerToken); //HEADER TOKEN
    }
}
